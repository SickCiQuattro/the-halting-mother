...
\end{verbatim}
Ciascuno scrive il proprio PNG in \texttt{Relazione/images/}, sovrascrivendo il file esistente. Un sesto script, \texttt{scripts/verifica\_limite\_ricorsione.py}, non produce immagini ma riproduce la verifica empirica del limite di ricorsione discussa nelle Conclusioni:
\begin{verbatim}
