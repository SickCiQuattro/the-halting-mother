...
La figura~\ref{fig:contesto_complemento_frontiera} mostra un esempio concreto su una griglia $15 \times 15$ con due ostacoli che spezzano parzialmente due quadranti dell'origine $O$: a sinistra sono evidenziati contesto (verde) e complemento (arancio), sovrapposti agli otto raggi primari (4 cardinali e 4 diagonali) effettivamente tracciati dall'algoritmo, il passo geometrico che precede le espansioni a gomito che riempiono il resto della chiusura; a destra la frontiera della loro unione (cerchiata in rosso).
