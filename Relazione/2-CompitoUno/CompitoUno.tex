...
I divisori che compaiono nello pseudocodice ($10$, $2{,}5$, $16$, $8$) traducono la quota di celle assegnata a ciascuna macrostruttura nel numero di istanze da generare, dividendo per il numero medio di celle occupate da un singolo agglomerato, coppia diagonale, recinto o barra rispettivamente.
...
\caption{Griglia $50 \times 50$ prodotta dal generatore con tipologie miste (\texttt{mix}) e densità $0.2$.}
